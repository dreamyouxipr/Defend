...
class Scene_2_11 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_2/BG11/BG-hd.pvr.png");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_2_12::createScene());
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_2_11::createScene());
		};
