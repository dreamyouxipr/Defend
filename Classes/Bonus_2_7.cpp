...
Bonus_2_7::Bonus_2_7(Node*scene,Vec2 pos)
{
	...
	auto sp = Sprite::createWithSpriteFrameName("cloud17.png");
	sprite->addChild(sp);
	sp->setPosition(sprite->getContentSize().width / 2, sprite->getContentSize().height - 50);


	sp->runAction(RepeatForever::create(RotateBy::create(1.5, 30)));
