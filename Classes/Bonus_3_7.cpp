...
Bonus_3_7::Bonus_3_7(Node*scene,Vec2 pos)
{
	
	string str = "cloud07.png";
	...
	menu->setPosition(pos.x+40,pos.y+40);
	menu;;
	...
	sprite->setPosition(pos.x + 40, pos.y+40);
	sprite;;
	...
	sprite->runAction(Sequence::create(DelayTime::create(rand()%5),CallFunc::create([=]()
	{


		auto ani = Animation::create();
		ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("cloud17.png"));
		ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("cloud27.png"));
		ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("cloud37.png"));
		ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("cloud47.png"));
		ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("cloud07.png"));

		ani->setDelayPerUnit(0.2);
		ani->setRestoreOriginalFrame(true);
		ani->setLoops(1);
		sprite->runAction(RepeatForever::create(Sequence::create(DelayTime::create(5), Animate::create(ani), nullptr)));
	...
	queue_takeplace_pos.push_back(Vec2(PublicFunc::convertToX(pos.x) + 1, PublicFunc::convertToY(pos.y)));

	queue_takeplace_pos.push_back(Vec2(PublicFunc::convertToX(pos.x) + 1, 1 + PublicFunc::convertToY(pos.y)));
