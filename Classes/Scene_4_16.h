...
class Scene_4_16: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_4/BG16/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_4_17::createScene());
	...
	callback_restart = [=]()
	{
		Director::getInstance()->replaceScene(Scene_4_16::createScene());
	};
