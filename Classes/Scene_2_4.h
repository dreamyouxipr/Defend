...
#include "Scene_2_5.h"
class Scene_2_4 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_2/BG4/BG-hd.pvr.png");
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_2_4::createScene());
		};
