...
class Scene_4_15: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_4/BG15/BG-hd.pvr.ccz");
	...
	callback_restart = [=]()
	{
		Director::getInstance()->replaceScene(Scene_4_15::createScene());
	};
