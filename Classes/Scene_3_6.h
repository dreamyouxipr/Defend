...
class Scene_3_6: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_3/BG6/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_3_7::createScene());


		};
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_3_6::createScene());
		};
