...
void Monster_land_boss_nima::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("land_boss_nima01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("land_boss_nima02.png"));
...
Monster_land_boss_nima::Monster_land_boss_nima(int t_hp, Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "land_boss_nima01.png";
	...
	hp_sprite_2->setPosition(Vec2(sprite->getContentSize().width / 3, sprite->getContentSize().height - 5));
	sprite->addChild(hp_sprite_2);



	hp_sprite_1 = Sprite::createWithSpriteFrameName("MonsterHP01.png");
	hp_sprite_1->setPosition(Vec2(sprite->getContentSize().width / 3, sprite->getContentSize().height - 5));
