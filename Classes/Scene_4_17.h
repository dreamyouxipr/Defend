...
class Scene_4_17: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_4/BG17/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_4_18::createScene());
