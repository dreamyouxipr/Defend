...
class Scene_3_7: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_3/BG7/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_3_8::createScene());
