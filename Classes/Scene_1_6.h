...
class Scene_1_6 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_1/BG6/BG-hd.pvr.png");
		path__->setPosition(WIDTH / 2+15, -4);
		p->addChild(path__);
	...
	virtual void initWave_manager()
	{
		...
		wave_manager->push_back(1, Each_One(3, 1), true);
		wave_manager->push_back(1, Each_One(3, 1));
		wave_manager->push_back(1, Each_One(3, 1));
		wave_manager->push_back(1, Each_One(3, 1));
		...
		wave_manager->push_back(4, Each_One(11, 60), true);
		...
		wave_manager->push_back(8, Each_One(12, 100), true);
		wave_manager->push_back(8, Each_One(12, 100));
		wave_manager->push_back(8, Each_One(12, 100));
		wave_manager->push_back(8, Each_One(12, 100));

		wave_manager->push_back(8, Each_One(12, 100));
		wave_manager->push_back(8, Each_One(12, 100));
		wave_manager->push_back(8, Each_One(12, 80));
		wave_manager->push_back(8, Each_One(12, 80));
		...
		wave_manager->push_back(10, Each_One(11, 170));
		wave_manager->push_back(10, Each_One(12, 99));
		wave_manager->push_back(10, Each_One(12, 99));
		wave_manager->push_back(10, Each_One(12, 99));
		wave_manager->push_back(10, Each_One(12, 99));

		wave_manager->push_back(10, Each_One(12, 1500));




		wave_manager->push_back(11, Each_One(4, 200), true);
		wave_manager->push_back(11, Each_One(4, 200));
		wave_manager->push_back(11, Each_One(4, 200));
		wave_manager->push_back(11, Each_One(4, 200));

		wave_manager->push_back(11, Each_One(4, 180));
		wave_manager->push_back(11, Each_One(4, 180));
		...
		wave_manager->push_back(14, Each_One(11, 250), true);
		wave_manager->push_back(14, Each_One(11, 250));
		wave_manager->push_back(14, Each_One(11, 250));
		wave_manager->push_back(14, Each_One(11, 250));
		...
		wave_manager->push_back(14, Each_One(12, 250));
		wave_manager->push_back(14, Each_One(12, 250));
		wave_manager->push_back(14, Each_One(12, 120));
		wave_manager->push_back(14, Each_One(12, 120));



		wave_manager->push_back(15, Each_One(3, 250), true);
		wave_manager->push_back(15, Each_One(3, 250));
		wave_manager->push_back(15, Each_One(3, 250));
		wave_manager->push_back(15, Each_One(3, 250));
		...
		wave_manager->push_back(15, Each_One(3, 250));
		wave_manager->push_back(15, Each_One(3, 250));
		wave_manager->push_back(15, Each_One(3, 120));
		wave_manager->push_back(15, Each_One(3, 120));
		...
		wave_manager->push_back(17, Each_One(10, 170), true);
		wave_manager->push_back(17, Each_One(6, 170));
...
*/
		...
		wave_manager->push_back(20, Each_One(11, 333), true);
		wave_manager->push_back(20, Each_One(11, 333));
		wave_manager->push_back(20, Each_One(11, 333));
		wave_manager->push_back(20, Each_One(11, 333));

		wave_manager->push_back(20, Each_One(8, 1300), true);
		wave_manager->push_back(20, Each_One(8, 1300), true);
		wave_manager->push_back(20, Each_One(8, 1300), true);
