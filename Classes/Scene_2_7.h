...
class Scene_2_7 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_2/BG7/BG-hd.pvr.png");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_2_8::createScene());
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_2_7::createScene());
		};
