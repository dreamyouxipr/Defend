...
void Monster_land_boss_star::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("land_boss_star01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("land_boss_star02.png"));
...
Monster_land_boss_star::Monster_land_boss_star(int t_hp, Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "land_boss_star01.png";
