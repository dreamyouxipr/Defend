...
#include "Scene_3_6.h"
class Scene_3_5: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_3/BG5/BG-hd.pvr.ccz");
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_3_5::createScene());
		};
