...
bool Scene_Selector_2::init()
{

	index_now = 0;

	Layer::init();
	SpriteFrameCache::getInstance()->addSpriteFramesWithFile("Scene_2/stages_theme2-hd.plist");
	...
	{
		Audio::play_Button();
		SpriteFrameCache::getInstance()->removeSpriteFramesFromFile("Scene_2/stages_theme2-hd.plist");
...
void Scene_Selector_2::setIndex(int index)
{
...
Scene* Scene_Selector_2::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_Selector_2::create();
	scene->addChild(layer);
	return scene;
}


void Scene_Selector_2::callback_play()
{
	//SpriteFrameCache::getInstance()->removeSpriteFramesFromFile("Scene_2/stages_theme2-hd.plist");
 
	switch (index_now)
	{
	case 0:  Director::getInstance()->pushScene(Scene_2_1::createScene()); break;
	case 1:  Director::getInstance()->pushScene(Scene_2_2::createScene()); break;
	case 2:  Director::getInstance()->pushScene(Scene_2_3::createScene()); break;
	case 3:  Director::getInstance()->pushScene(Scene_2_4::createScene()); break;
	case 4:  Director::getInstance()->pushScene(Scene_2_5::createScene()); break;
	case 5:  Director::getInstance()->pushScene(Scene_2_6::createScene()); break;
	case 6:  Director::getInstance()->pushScene(Scene_2_7::createScene()); break;
	case 7:  Director::getInstance()->pushScene(Scene_2_8::createScene()); break;
	case 8:  Director::getInstance()->pushScene(Scene_2_9::createScene()); break;
	case 9:  Director::getInstance()->pushScene(Scene_2_10::createScene()); break;
	case 10:  Director::getInstance()->pushScene(Scene_2_11::createScene()); break;
	case 11:  Director::getInstance()->pushScene(Scene_2_12::createScene()); break;
