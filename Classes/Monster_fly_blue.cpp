...
void Monster_fly_blue::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("fly_blue01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("fly_blue02.png"));
...
void Monster_fly_blue::playEffect()
{
	...
	case '1':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly161.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly162.mp3"); break;
				case 2:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly162.mp3"); break;
	...
	case '2':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly261.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly262.mp3"); break;
				case 2:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly263.mp3"); break;
				}
	...
	case '3':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly361.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly362.mp3"); break;
				case 2:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly362.mp3"); break;
	...
	case '4':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly661.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly662.mp3"); break;
				case 2:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Fly663.mp3"); break;
				}
	}break;
...
Monster_fly_blue::Monster_fly_blue(int t_hp, Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "fly_blue01.png";
