...
void Scene_Selector_4::setIndex(int index)
{
...
Scene* Scene_Selector_4::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_Selector_4::create();
	scene->addChild(layer);
	return scene;
}


void Scene_Selector_4::callback_play()
{
	...
	switch (index_now)
	{
	case 0:  Director::getInstance()->pushScene(Scene_4_1::createScene()); break;
	case 1:  Director::getInstance()->pushScene(Scene_4_2::createScene()); break;
	case 2:  Director::getInstance()->pushScene(Scene_4_3::createScene()); break;
	case 3:  Director::getInstance()->pushScene(Scene_4_4::createScene()); break;
	case 4:  Director::getInstance()->pushScene(Scene_4_5::createScene()); break;
	case 5:  Director::getInstance()->pushScene(Scene_4_6::createScene()); break;
	case 6:  Director::getInstance()->pushScene(Scene_4_7::createScene()); break;
	case 7:  Director::getInstance()->pushScene(Scene_4_8::createScene()); break;
	case 8:  Director::getInstance()->pushScene(Scene_4_9::createScene()); break;
	case 9:  Director::getInstance()->pushScene(Scene_4_10::createScene()); break;
	case 10:  Director::getInstance()->pushScene(Scene_4_11::createScene()); break;
	case 11:  Director::getInstance()->pushScene(Scene_4_12::createScene()); break;


	case 12:  Director::getInstance()->pushScene(Scene_4_13::createScene()); break;
	case 13:  Director::getInstance()->pushScene(Scene_4_14::createScene()); break;
	case 14:  Director::getInstance()->pushScene(Scene_4_15::createScene()); break;
	case 15:  Director::getInstance()->pushScene(Scene_4_16::createScene()); break;
	case 16:  Director::getInstance()->pushScene(Scene_4_17::createScene()); break;
	case 17:  Director::getInstance()->pushScene(Scene_4_18::createScene()); break;
