...
class Scene_4_13: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_4/BG13/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_4_14::createScene());
	...
	callback_restart = [=]()
	{
		Director::getInstance()->replaceScene(Scene_4_13::createScene());
	};
