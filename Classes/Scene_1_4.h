...
#include "Scene_1_5.h"
class Scene_1_4 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_1/BG4/BG-hd.pvr.png");
		path__->setPosition(WIDTH / 2+40, -4);
		p->addChild(path__);
	...
	virtual void initWave_manager()
	{
		...
		wave_manager->push_back(3, Each_One(11, 52), true);
		...
		wave_manager->push_back(7, Each_One(12, 100), true);
		wave_manager->push_back(7, Each_One(12, 100));
		wave_manager->push_back(7, Each_One(12, 100));
		wave_manager->push_back(7, Each_One(12, 100));

		wave_manager->push_back(7, Each_One(12, 120));
		wave_manager->push_back(7, Each_One(12, 120));
		wave_manager->push_back(7, Each_One(12, 120));
		wave_manager->push_back(7, Each_One(12, 120));
		wave_manager->push_back(7, Each_One(12, 120));
		...
		wave_manager->push_back(10, Each_One(13, 170), true);
		wave_manager->push_back(10, Each_One(13, 170));
		wave_manager->push_back(10, Each_One(13, 170));
		wave_manager->push_back(10, Each_One(13, 170));
		...
		wave_manager->push_back(12, Each_One(4, 100));
		wave_manager->push_back(12, Each_One(4, 100));
		wave_manager->push_back(12, Each_One(3, 100));
		wave_manager->push_back(12, Each_One(3, 100));
		...
		wave_manager->push_back(17, Each_One(4, 170), true);
		wave_manager->push_back(17, Each_One(4, 170));
		wave_manager->push_back(17, Each_One(4, 170));
		wave_manager->push_back(17, Each_One(4, 170));

		wave_manager->push_back(17, Each_One(11, 170));
		wave_manager->push_back(17, Each_One(11, 170));
		wave_manager->push_back(17, Each_One(11, 300));
		wave_manager->push_back(17, Each_One(11, 300));
		wave_manager->push_back(17, Each_One(11, 300));
		wave_manager->push_back(17, Each_One(11, 300));
		...
		wave_manager->push_back(19, Each_One(4, 333), true);
		wave_manager->push_back(19, Each_One(4, 333));
		wave_manager->push_back(19, Each_One(4, 333));
		wave_manager->push_back(19, Each_One(4, 333));
		...
		wave_manager->push_back(20, Each_One(2, 280), true);
		wave_manager->push_back(20, Each_One(2, 280));
		wave_manager->push_back(20, Each_One(2, 280));
		wave_manager->push_back(20, Each_One(2, 280));

		wave_manager->push_back(20, Each_One(2, 280));
		wave_manager->push_back(20, Each_One(1, 2500));
