...
void Monster_boss_big::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("boss_big01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("boss_big02.png"));
...
Monster_boss_big::Monster_boss_big(int t_hp, Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "boss_big01.png";
