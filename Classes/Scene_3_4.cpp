...
Scene* Scene_3_4::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_3_4::create();
...
void Scene_3_4::initBonus()
{
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(0, 6)));
	monster_queue.push_back(new  Bonus_3_1(this, PublicFunc::convertToPoint(1, 6)));
	monster_queue.push_back(new  Bonus_3_8(this, PublicFunc::convertToPoint(2, 6)));
	monster_queue.push_back(new  Bonus_3_1(this, PublicFunc::convertToPoint(3, 6)));
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(4, 6)));
	monster_queue.push_back(new  Bonus_3_9(this, PublicFunc::convertToPoint(6, 6)));
	...
	monster_queue.push_back(new  Bonus_3_9(this, PublicFunc::convertToPoint(3, 5)));

	monster_queue.push_back(new  Bonus_3_8(this, PublicFunc::convertToPoint(0, 4)));
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(6, 4)));
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(7, 4)));
	monster_queue.push_back(new  Bonus_3_2(this, PublicFunc::convertToPoint(11, 4)));
	...
	monster_queue.push_back(new  Bonus_3_1(this, PublicFunc::convertToPoint(0, 3)));
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(2, 3)));
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(5, 3)));
	monster_queue.push_back(new  Bonus_3_1(this, PublicFunc::convertToPoint(6, 3)));
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(7, 3)));
	monster_queue.push_back(new  Bonus_3_7(this, PublicFunc::convertToPoint(8, 3)));
	...
	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(2, 2)));
	monster_queue.push_back(new  Bonus_3_6(this, PublicFunc::convertToPoint(3, 2)));
	monster_queue.push_back(new  Bonus_3_2(this, PublicFunc::convertToPoint(11, 2)));

	monster_queue.push_back(new  Bonus_3_4(this, PublicFunc::convertToPoint(3, 1)));

	monster_queue.push_back(new  Bonus_3_6(this, PublicFunc::convertToPoint(6, 0)));
