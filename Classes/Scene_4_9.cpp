...
Scene* Scene_4_9::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_4_9::create();
...
void Scene_4_9::initBonus()
{
	
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(0, 6)));
	...
	monster_queue.push_back(new  Bonus_4_3(this, PublicFunc::convertToPoint(7, 6)));
	...
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(2, 5)));

	monster_queue.push_back(new  Bonus_4_3(this, PublicFunc::convertToPoint(0, 4)));
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(5, 4)));
	monster_queue.push_back(new  Bonus_4_1(this, PublicFunc::convertToPoint(11, 4)));

	monster_queue.push_back(new  Bonus_4_1(this, PublicFunc::convertToPoint(0, 3)));
	monster_queue.push_back(new  Bonus_4_6(this, PublicFunc::convertToPoint(2, 3)));
	monster_queue.push_back(new  Bonus_4_1(this, PublicFunc::convertToPoint(7, 3)));
	...
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(2, 2)));
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(4, 2)));
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(7, 2)));
	...
	monster_queue.push_back(new  Bonus_4_5(this, PublicFunc::convertToPoint(7, 0)));
