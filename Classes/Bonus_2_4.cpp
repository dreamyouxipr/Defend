...
Bonus_2_4::Bonus_2_4(Node*scene,Vec2 pos,bool is_flip)
{
	
	string str = "cloud04.png";
	...
	menu->setPosition(pos.x+40,pos.y);
	menu;;
	...
	sprite->setPosition(pos.x + 40, pos.y);
	sprite;;
