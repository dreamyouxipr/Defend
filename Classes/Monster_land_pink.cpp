...
void Monster_land_pink::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("land_pink01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("land_pink02.png"));
...
void Monster_land_pink::playEffect()
{
	...
	case '1':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land111.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land112.mp3"); break;
				case 2:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land113.mp3"); break;
				}
	}break;
	...
	case '2':
	{
					...
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land211.mp3"); break;
	...
	case '3':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land311.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land312.mp3"); break;
	...
	case '4':
	{
				...
				{
				case 0:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land611.mp3"); break;
				case 1:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land612.mp3"); break;
				case 2:
					SimpleAudioEngine::getInstance()->playEffect("Music/Monster/Land613.mp3"); break;
				}
	}break;
...
Monster_land_pink::Monster_land_pink(int t_hp,Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "land_pink01.png";
