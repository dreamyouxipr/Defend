...
#include "Scene_3_1.h"
class Scene_2_12 : public Scene_UI
{
public:
	...
	virtual void removeRes()
	{
		...
		SpriteFrameCache::getInstance()->removeSpriteFramesFromFile("Scene_2/Object02-hd.plist");
	...
	virtual void initScene(Node*p)
	{
		...
		auto bg = Sprite::create("Scene_2/BG0/BG2-hd.pvr.png");
		p->addChild(bg);
		bg->setPosition(WIDTH / 2, 640 / 2);
		

		auto path__ = Sprite::create("Scene_2/BG12/BG-hd.pvr.png");
		path__->setPosition(WIDTH / 2,0);
		p->addChild(path__);
		path__->setAnchorPoint(Vec2(0.5,0));

		SpriteFrameCache::getInstance()->addSpriteFramesWithFile("Scene_2/Object02-hd.plist");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_3_1::createScene());
