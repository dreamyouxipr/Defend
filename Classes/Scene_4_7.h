...
#include "Scene_4_8.h"
class Scene_4_7: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_4/BG7/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_4_8::createScene());
	...
	callback_restart = [=]()
	{
		Director::getInstance()->replaceScene(Scene_4_7::createScene());
	};
