...
class Scene_2_5 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_2/BG5/BG-hd.pvr.png");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_2_6::createScene());
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_2_5::createScene());
		};
