...
void Monster_fat_boss_green::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("fat_boss_green01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("fat_boss_green02.png"));
...
Monster_fat_boss_green::Monster_fat_boss_green(int t_hp, Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "fat_boss_green01.png";
