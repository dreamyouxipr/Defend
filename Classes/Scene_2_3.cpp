...
Scene* Scene_2_3::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_2_3::create();
...
void Scene_2_3::initBonus()
{
	...
	monster_queue.push_back(new  Bonus_2_6(this, PublicFunc::convertToPoint(2, 3)));


	monster_queue.push_back(new  Bonus_2_7(this, PublicFunc::convertToPoint(5, 1)));


	monster_queue.push_back(new  Bonus_2_4(this, PublicFunc::convertToPoint(5, 4)));
