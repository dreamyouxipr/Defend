...
class Scene_1_11 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_1/BG11/BG-hd.pvr.png");
		path__->setPosition(WIDTH / 2 - 0, -4);
		p->addChild(path__);
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_1_12::createScene());
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_1_11::createScene());
		};
