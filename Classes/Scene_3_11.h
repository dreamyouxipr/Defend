...
class Scene_3_11: public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_3/BG11/BG-hd.pvr.ccz");
		...
		callback_next = [=]()
		{
			...
			Director::getInstance()->replaceScene(Scene_3_12::createScene());
