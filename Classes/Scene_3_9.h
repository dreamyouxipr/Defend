...
class Scene_3_9: public Scene_UI
{
public:
	...
	virtual void removeRes()
	{
		...
		SpriteFrameCache::getInstance()->removeSpriteFramesFromFile("Scene_3/Object01-hd.plist");
	...
	virtual void initScene(Node*p)
	{
		...
		auto bg = Sprite::create("Scene_3/BG0/BG1-hd.pvr.ccz");
		p->addChild(bg);
		bg->setPosition(WIDTH / 2, 640 / 2);
		

		auto path__ = Sprite::create("Scene_3/BG9/BG-hd.pvr.ccz");
		path__->setPosition(WIDTH / 2,0);
		p->addChild(path__);
		path__->setAnchorPoint(Vec2(0.5,0));

		SpriteFrameCache::getInstance()->addSpriteFramesWithFile("Scene_3/Object01-hd.plist");
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_3_9::createScene());
		};
