...
void Monster_fly_boss_blue::runMoveAction()
{
	auto ani = Animation::create();
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("fly_boss_blue01.png"));
	ani->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("fly_boss_blue02.png"));
...
Monster_fly_boss_blue::Monster_fly_boss_blue(int t_hp, Node*scene, Vec2 pos, queue<Vec2> que)
{

	string str = "fly_boss_blue01.png";
