...
bool Scene_Selector_1::init()
{
	index_now = 0;

	Layer::init();
	SpriteFrameCache::getInstance()->addSpriteFramesWithFile("Scene_1/stages_theme1-hd.plist");
	...
	{
		Audio::play_Button();
		SpriteFrameCache::getInstance()->removeSpriteFramesFromFile("Scene_1/stages_theme1-hd.plist");
...
void Scene_Selector_1::setIndex(int index)
{
...
Scene* Scene_Selector_1::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_Selector_1::create();
	scene->addChild(layer);
	return scene;
}


void Scene_Selector_1::callback_play()
{
	...
	switch (index_now)
	{
	case 0:  Director::getInstance()->pushScene(Scene_1_1::createScene()); break;
	case 1:  Director::getInstance()->pushScene(Scene_1_2::createScene()); break;
	case 2:  Director::getInstance()->pushScene(Scene_1_3::createScene()); break;
	case 3:  Director::getInstance()->pushScene(Scene_1_4::createScene()); break;
	case 4:  Director::getInstance()->pushScene(Scene_1_5::createScene()); break;
	case 5:  Director::getInstance()->pushScene(Scene_1_6::createScene()); break;
	case 6:  Director::getInstance()->pushScene(Scene_1_7::createScene()); break;
	case 7:  Director::getInstance()->pushScene(Scene_1_8::createScene()); break;
	case 8:  Director::getInstance()->pushScene(Scene_1_9::createScene()); break;
	case 9:  Director::getInstance()->pushScene(Scene_1_10::createScene()); break;
	case 10:  Director::getInstance()->pushScene(Scene_1_11::createScene()); break;
	case 11:  Director::getInstance()->pushScene(Scene_1_12::createScene()); break;
...
void  Scene_Selector_1::sync()
{
	sprite_lock->setVisible(false);

	sprintf(str, "all_1_%d", index_now + 1);

	sprite_allclear->setVisible(PublicFunc::getUserDefault_AllClear_ByKey(str));

	sprite_lev;;

	sprintf(str, "1_%d", index_now + 1);


	//log("%d", PublicFunc::getUserDefault_Lev_ByKey(str));
