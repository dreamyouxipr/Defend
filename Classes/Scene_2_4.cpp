...
Scene* Scene_2_4::createScene()
{
	auto scene = Scene::create();
	auto layer = Scene_2_4::create();
...
void Scene_2_4::initBonus()
{
	
	
	monster_queue.push_back(new  Bonus_2_4(this, PublicFunc::convertToPoint(0, 2)));
	
	monster_queue.push_back(new  Bonus_2_5(this, PublicFunc::convertToPoint(0, 4)));

	monster_queue.push_back(new  Bonus_2_2(this, PublicFunc::convertToPoint(3, 2)));
	monster_queue.push_back(new  Bonus_2_1(this, PublicFunc::convertToPoint(3, 3)));
	monster_queue.push_back(new  Bonus_2_1(this, PublicFunc::convertToPoint(3, 4)));
	monster_queue.push_back(new  Bonus_2_1(this, PublicFunc::convertToPoint(3, 5)));

	monster_queue.push_back(new  Bonus_2_3(this, PublicFunc::convertToPoint(5, 2)));
	monster_queue.push_back(new  Bonus_2_2(this, PublicFunc::convertToPoint(5, 3)));
	monster_queue.push_back(new  Bonus_2_3(this, PublicFunc::convertToPoint(5, 4)));


	monster_queue.push_back(new  Bonus_2_1(this, PublicFunc::convertToPoint(7, 2)));
	monster_queue.push_back(new  Bonus_2_2(this, PublicFunc::convertToPoint(7, 3)));
	monster_queue.push_back(new  Bonus_2_1(this, PublicFunc::convertToPoint(7, 4)));


	monster_queue.push_back(new  Bonus_2_7(this, PublicFunc::convertToPoint(9, 2)));
	monster_queue.push_back(new  Bonus_2_6(this, PublicFunc::convertToPoint(8, 5)));
