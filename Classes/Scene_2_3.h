...
#include "Scene_2_4.h"
class Scene_2_3 : public Scene_UI
{
public:
	...
	virtual void initScene(Node*p)
	{
		...
		auto path__ = Sprite::create("Scene_2/BG3/BG-hd.pvr.png");
		...
		callback_restart = [=]()
		{
			Director::getInstance()->replaceScene(Scene_2_3::createScene());
		};
